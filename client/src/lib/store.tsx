...
export type ScoringType = "score" | "grade" | "text" | "boolean";
...
const DEFAULT_SCHEMA: ScoringItem[] = [
  ...
  { id: "auto_score_top", label: "自動頂層得分", type: "score", min: 0, max: 99, order: 1 },
  { id: "tele_score_top", label: "手動頂層得分", type: "score", min: 0, max: 99, order: 2 },
